...
using System.Data.SqlClient;
    ...
    public partial class _Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "INSERT INTO devices_of_users (device_name, device_type,device_id,user_id,token,status) VALUES ('" + Request["device_name"] + "', '" +
            Request["device_type"] + "', '" + Request["device_id"] + "', '" + Request["user_id"] + "', '" + Request["token"] + "', '" + Request["status"] + "')";
